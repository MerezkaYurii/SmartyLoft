...
export default function AdminLoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-start pt-7 justify-center bg-gray-100 dark:bg-gray-950 px-4">
      <div>
        <Link
          href={`/${lang}`}
          className="block text-center text-sm text-gray-900 hover:underline  hover:text-gray-700 dark:text-gray-200 dark:hover:text-white  whitespace-nowrap mb-6 "
        >
