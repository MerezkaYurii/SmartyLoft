    ...
    <div className="flex min-h-[calc(100vh-70px)] items-center justify-center px-4">
      <div className="w-full max-w-md bg-white/80 dark:bg-gray-900/80 backdrop-blur-md p-8 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 transition-colors duration-500">
        ...
        <button
          ...
          type="button"
          className="w-full flex items-center justify-center gap-2 py-2 px-4 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-white font-medium rounded-lg border border-gray-300 dark:border-gray-600 transition-colors shadow-sm"
        >
          {/* Иконка Google */}
          <svg
            className="w-5 h-5"
