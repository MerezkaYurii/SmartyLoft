    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            <button
                ...
                style={{ paddingLeft: '5px', paddingRight: '5px', paddingTop: '2px', paddingBottom: '3px' }}
            ...
            >
                <svg className="w-5 h-5 fill-white stroke-none " strokeWidth="1.5" viewBox="0 0 24 24">
                    <use href="/spriteSL.svg#icon-sphere" />
                </svg>

                <span className="font-regular text-sm">{dict.header.language}</span>

                <svg className={`w-3 h-3 fill-white stroke-none transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
                ...
                <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-gray-500 rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
                    {[
                        ...
                        <button
                            ...
                            className={`block w-full text-left px-4 py-2 text-sm hover:bg-gray-200 dark:hover:bg-gray-600 ${currentLocale === lang.code
