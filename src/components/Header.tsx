    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-gray-400/80 shadow-sm dark:bg-gray-900/70 dark:text-white transition-colors duration-500 ">
      <div className="container mx-auto px-4 sm:px-6 py-3 flex items-center justify-between h-[70px] ">
        <Link href={`/${currentLocale}`} className="flex items-center ">
          <svg className="w-32 md:w-40 h-auto dark:hidden">
            <use href="/spriteSL.svg#icon-Logo-smartyloft" />
          </svg>
          <svg className="w-32 md:w-40 h-auto hidden dark:block">
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-4 md:gap-6 flex-1 min-w-0">
          <div className="hidden lg:block  max-w-[120px] sm:max-w-none whitespace-nowrap">
          ...
          <Link
            ...
            className="hidden lg:flex items-center font-medium text-black hover:text-[#0f3995] dark:text-white"
          >
